...
│   │   └── profiles.R                  # Profiles about Core Informatics Team and its members, link to associated website(s)
|   |
│   └── components/
...
```r
shiny::runApp('app/main.R', port = 7000, host = "0.0.0.0")
```
...
<!-- 
## Status
This is active project code rather than a polished release branch. Expect ongoing refactoring around the API boundary, dataset comparison views, and broader plot support. -->
